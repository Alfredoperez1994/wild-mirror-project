        ...
        >
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center mb-24 ">
                ...
                <div className="mt-12 md:mt-0 md:ml-10">
                    <img
                        src="/img/discover/aire_35.jpeg"
                        alt="Naturaleza"
                        className="object-cover h-96 w-80 md:h-100 md:w-240 lg:w-200 lg:h-120 xl:w-180 xl:h-150 shadow-xl/100 shadow-black hover:scale-105 transition-transform duration-700"
                    />
                </div>
            </div>
            ...
            <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen my-24 overflow-hidden shadow-xl/100 shadow-black">
                <img src="/img/discover/tierra_07.jpeg" alt="" className="h-64 md:h-100 lg:h-100 w-full object-cover brightness-90" />
            </div>

            <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row justify-between items-center mb-32">

                {/* Imagen destacada */}
                <div className="mt-12 md:mt-0 md:mr-10 md:w-1/2 flex justify-center">
                    <img
                        src="/img/discover/tierra_12.jpeg"
                        alt="Naturaleza"
                ...
                <div className="flex flex-col gap-4 text-left md:w-1/2">
                    <h3 className="font-mono text-3xl md:text-5xl uppercase tracking-widest mb-4">
            ...
            <div className="discover__gallery grid grid-cols-2 md:grid-cols-4 gap-4 mb-20">
                {[
                    { src: "/img/discover/tierra_55.jpeg", alt: "Elefante" },
                    { src: "/img/discover/temple.jpeg", alt: "Templo" },
                    { src: "/img/discover/tierra_46.jpeg", alt: "Tren" },
                    { src: "/img/discover/fuego_09.jpeg", alt: "Calle" },
                ].map((img, i) => (
                    <div
                        key={i}
                        className="overflow-hidden transform transition-all duration-700 hover:scale-105 hover:shadow-2xl"
                    >
                        <img
                            src={img.src}
                            alt={img.alt}
            ...
            <div>
                <img className="opacity-80 -mb-32" src="/img/discover/133.png" alt="" />
            </div>
